...
func id(c *gin.Context) (int, bool) {
	...
	if err != nil {
		c.JSON(http.StatusBadRequest, models.ErrorResponse{Error: "неверный id"})
		return 0, false
	}
	return n, true
}
...
func (h *Handler) deleteUser(c *gin.Context) {
	...
	if err := h.svc.DeleteUser(n); err != nil {
		fail(c, 404, err)
		return
	}
...
func (h *Handler) deleteShip(c *gin.Context) {
	...
	if err := h.svc.DeleteShip(n); err != nil {
		fail(c, 404, err)
		return
	}
...
func (h *Handler) deleteVisit(c *gin.Context) {
	...
	if err := h.svc.DeleteVisit(n); err != nil {
		fail(c, 404, err)
		return
	}
